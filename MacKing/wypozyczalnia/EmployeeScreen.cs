    ...
    public partial class EmployeeScreen : UserControl
    {
        ...
        void CompleteProduct(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string connection = "Data Source=Damian-PC\\SQLEXPRESS;Initial Catalog=Fastfood;Integrated Security=True";//Damian-PC
                SqlConnection conn = new SqlConnection(connection);
                conn.Open();
        ...
        void CompleteOrder(object sender, EventArgs e)
        {
            ...
            string connection = "Data Source=Damian-PC\\SQLEXPRESS;Initial Catalog=Fastfood;Integrated Security=True";//Damian-PC // Damian-PC
            SqlConnection conn = new SqlConnection(connection);
            conn.Open();
